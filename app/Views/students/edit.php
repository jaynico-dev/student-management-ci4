...
<form method="POST" action="/students/update/<?= $student['id'];?>" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="student_section" name="student_section"
            value="<?= $student['student_section'] ?>" required>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="student_course" name="student_course"
            value="<?= $student['student_course'] ?>" required>
    </div>

    <div class="mb-3">
        <label for="student_batch" class="form-label">Student Batch</label>
        <input type="text" class="form-control" id="student_batch" name="student_batch"
            value="<?= $student['student_batch'] ?>" required>
    </div>

    <div class="mb-3">
        <label for="student_grade_level" class="form-label">Student Grade Level</label>
        <input type="text" class="form-control" id="student_grade_level" name="student_grade_level"
            value="<?= $student['student_grade_level'] ?>" required>
    </div>
